    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".grpc.reflection.v1.ExtensionRequest",
          default_value: nil,
          options: nil,
          oneof_index: 0,
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".grpc.reflection.v1.ServerReflectionRequest",
          default_value: nil,
          options: nil,
          oneof_index: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".grpc.reflection.v1.FileDescriptorResponse",
          default_value: nil,
          options: nil,
          oneof_index: 0,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".grpc.reflection.v1.ExtensionNumberResponse",
          default_value: nil,
          options: nil,
          oneof_index: 0,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".grpc.reflection.v1.ListServiceResponse",
          default_value: nil,
          options: nil,
          oneof_index: 0,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".grpc.reflection.v1.ErrorResponse",
          default_value: nil,
          options: nil,
          oneof_index: 0,
...
defmodule Grpc.Reflection.V1.ListServiceResponse do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_REPEATED,
          type: :TYPE_MESSAGE,
          type_name: ".grpc.reflection.v1.ServiceResponse",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "service",
  ...
  field :service, 1, repeated: true, type: Grpc.Reflection.V1.ServiceResponse
end
...
defmodule Grpc.Reflection.V1.ServerReflection.Service do
  @moduledoc false
    ...
    %Google.Protobuf.ServiceDescriptorProto{
      ...
      method: [
        %Google.Protobuf.MethodDescriptorProto{
          ...
          input_type: ".grpc.reflection.v1.ServerReflectionRequest",
          output_type: ".grpc.reflection.v1.ServerReflectionResponse",
          options: nil,
  ...
  rpc :ServerReflectionInfo,
      stream(Grpc.Reflection.V1.ServerReflectionRequest),
      stream(Grpc.Reflection.V1.ServerReflectionResponse)
end

defmodule Grpc.Reflection.V1.ServerReflection.Stub do
  @moduledoc false

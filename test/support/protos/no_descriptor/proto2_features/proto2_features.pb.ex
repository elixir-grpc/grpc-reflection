...
defmodule NoDescriptor.Proto2Features.Proto2Request.MetadataMapEntry do
  ...
  use Protobuf,
    ...
    map: true,
    proto_source: "proto2_features.proto",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule NoDescriptor.Proto2Features.Proto2Service.Service do
  ...
  use GRPC.Service, name: "proto2_features.Proto2Service", protoc_gen_elixir_version: "0.17.0"

  def proto_source(), do: "proto2_features.proto"

defmodule NoDescriptor.Streaming.StreamRequest do
  ...
  use Protobuf,
    ...
    proto_source: "streaming_service.proto",
...
defmodule NoDescriptor.Streaming.StreamingService.Service do
  ...
  use GRPC.Service, name: "streaming.StreamingService", protoc_gen_elixir_version: "0.17.0"

  def proto_source(), do: "streaming_service.proto"
...
defmodule NoDescriptor.Streaming.MultiStreamService.Service do
  ...
  use GRPC.Service, name: "streaming.MultiStreamService", protoc_gen_elixir_version: "0.17.0"

...
defmodule NoDescriptor.Nested.OuterMessage.MiddleMessage.InnerMessage.DeepMessage.VeryDeepMessage do
  ...
  use Protobuf,
    ...
    proto_source: "nested_messages.proto",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule NoDescriptor.Nested.NestedService.Service do
  ...
  use GRPC.Service, name: "nested.NestedService", protoc_gen_elixir_version: "0.17.0"

  def proto_source(), do: "nested_messages.proto"
...
defmodule NoDescriptor.Nested.AnotherNestedService.Service do
  ...
  use GRPC.Service, name: "nested.AnotherNestedService", protoc_gen_elixir_version: "0.17.0"

defmodule ImportsTest.UserRequest do
  ...
  use Protobuf,
    ...
    proto_source: "imports_test.proto",
...
defmodule ImportsTest.ImportTestService.Service do
  ...
  use GRPC.Service, name: "imports_test.ImportTestService", protoc_gen_elixir_version: "0.17.0"

  def proto_source(), do: "imports_test.proto"

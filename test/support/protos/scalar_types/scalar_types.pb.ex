defmodule ScalarTypes.ScalarRequest do
  ...
  use Protobuf,
    ...
    proto_source: "scalar_types.proto",
...
defmodule ScalarTypes.ScalarService.Service do
  ...
  use GRPC.Service, name: "scalar_types.ScalarService", protoc_gen_elixir_version: "0.17.0"

  def proto_source(), do: "scalar_types.proto"
